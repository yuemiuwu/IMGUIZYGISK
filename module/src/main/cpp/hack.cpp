...
void (*old_ambus)(void *instance, int value, void* analyticsSource);
void ambus(void *instance, int value, void* analyticsSource) {
    ...
    old_ambus(instance, value, analyticsSource);
}
...
DobbyHook((void *)getAbsoluteAddress("libil2cpp", "0x133949"), (void *)ambus, (void **)&old_ambus);
